...
TARGET := $(TARGET_NAME)
CFLAGS += -DNP2KAI_GIT_TAG=\"$(GIT_TAG)\" -DNP2KAI_GIT_HASH=\"$(GIT_HASH)\" -DNP2KAI_BUILDER=\"$(BUILDER)\"
CXXFLAGS += -DNP2KAI_GIT_TAG=\"$(GIT_TAG)\" -DNP2KAI_GIT_HASH=\"$(GIT_HASH)\" -DNP2KAI_BUILDER=\"$(BUILDER)\"
fpic = -fPIC
