/* === communication management header for wx port === */

#ifndef NP2_WX_COMMNG_H__
#define NP2_WX_COMMNG_H__

/* com manager interface (shared with core) */
