...
{
	/* test result on Linux 106_ja/101_us:Twocode/caNnotpush/Miss/Different */
	...
	{RETROK_1,		0x01},	/* 1 ! */
	{RETROK_2,		0x02},	/* 2 " (1:T 0x02,0x2A)*/
	{RETROK_3,		0x03},	/* 3 # */
	{RETROK_4,		0x04},	/* 4 $ */
	{RETROK_5,		0x05},	/* 5 % */
	{RETROK_6,		0x06},	/* 6 & */
	{RETROK_7,		0x07},	/* 7 ' (6:T 0x07,0x27) */
	{RETROK_8,		0x08},	/* 8 ( */
	{RETROK_9,		0x09},	/* 9 ) */
	{RETROK_0,		0x0a},	/* 0 0 */
	{RETROK_MINUS,		0x0b},	/* - = (6:T 0x0B,0x0C 1:T 0x0B,0x33) */
	{RETROK_CARET,		0x0c},	/* ^ ` (6:M) */
	{RETROK_BACKSLASH,	0x0d},	/* Yen | (6:M) */
	...
	{RETROK_k,		0x24},	/* k K */
	{RETROK_l,		0x25},	/* l L */
	{RETROK_SEMICOLON,	0x26},	/* ; + (1:T 0x26,0x27) */
	{RETROK_COLON,		0x27},	/* : * */
	...
	{RETROK_PERIOD,		0x31},	/* . > */
	{RETROK_SLASH,		0x32},	/* / ? */
	{RETROK_UNDERSCORE,	0x33},	/* _ _ (6:T 0x0D,0x33) */
	...
	{RETROK_KP2,		0x4b},	/* KP2 */
	{RETROK_KP3,		0x4c},	/* KP3 */
	{RETROK_KP_EQUALS,	0x4d},	/* KP= (6:N 1:N) */
	{RETROK_KP0,		0x4e},	/* KP0 */
	/* KP, */
	{RETROK_KP_PERIOD,	0x50},	/* KP. (6:M 1:M) */
...
static const SDLKCNV sdlcnv106[] =
{
	...
	{SDL_SCANCODE_PRINTSCREEN,	0x61},	/* COPY (6:M 1:M) */
	...
	{SDL_SCANCODE_INTERNATIONAL3,	0x0d},	/* Yen | (1:D 0x28) */
	...
	{SDL_SCANCODE_BACKSLASH,	0x28},	/* ] } (1:N) */
	...
	{SDL_SCANCODE_INTERNATIONAL1,	0x33},	/* _ _ (1:N) */
	{SDL_SCANCODE_RSHIFT,		0x75},	/* RShift */

	/* Kana */
	{SDL_SCANCODE_LGUI,		0x70},	/* LSuper (6:M 1:M) */
	...
	{SDL_SCANCODE_KP_EQUALS,	0x4d},	/* KP= (6:N 1:N) */
